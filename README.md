...
<p>
🔐 Cybersecurity • 💻 Information Technology • 🌐 Networking • 🛡️ DevSecOps
</p>
...
<ul>
  <li>🎓 Undergraduate student in Computing</li>
  <li>🔐 Strongly interested in Cybersecurity and Information Technology</li>
  <li>🌐 Learning computer networking, systems and web technologies</li>
  <li>🛡️ Exploring Cybersecurity, DevSecOps and secure software development</li>
  <li>💻 Developing programming skills in Java and Python</li>
  <li>🐧 Learning Linux and working with virtualized environments</li>
  <li>🤖 Exploring Artificial Intelligence and Machine Learning</li>
  <li>🧪 Learning software testing and security testing concepts</li>
  <li>🛠️ Building university and personal technology projects</li>
  <li>📚 Continuously improving my technical and problem-solving skills</li>
</ul>
...
🛡️ DevSecOps & Secure Development<br>
🐧 Linux Administration<br>
🌍 Web Application Security<br>
🧪 Software & Security Testing<br>
...
<h3>🔐 DevSecOps & OWASP Juice Shop</h3>

<p>
Exploring web application security, secure development practices,
vulnerability analysis and DevSecOps concepts using OWASP Juice Shop.
</p>

<p>
<b>Focus:</b> Cybersecurity • Web Security • DevSecOps • Secure Coding
</p>

<h3>💇 Beauty Salon Management System</h3>

<p>
A Java-based web application for managing salon services,
appointments, users and customer inquiries.
</p>

<p>
<b>Focus:</b> Java • Web Development • Database Management
</p>

<h3>🤖 Machine Learning Projects</h3>

<p>
Exploring machine-learning concepts including data preprocessing,
classification algorithms and model evaluation.
</p>

<p>
<b>Focus:</b> Python • Machine Learning • Data Analysis
</p>
...
<ul>
  <li>🔐 Build a strong foundation in Cybersecurity</li>
  <li>🌐 Improve my networking and IT infrastructure knowledge</li>
  <li>🐧 Develop stronger Linux administration skills</li>
  <li>🛡️ Learn more about secure software development and DevSecOps</li>
  <li>💻 Continue improving my programming skills</li>
  <li>🚀 Build practical Cybersecurity and IT projects</li>
  <li>🤝 Contribute to open-source projects</li>
  <li>💼 Prepare for future IT and Cybersecurity career opportunities</li>
</ul>
...
<p>
I use GitHub to document my university projects, Cybersecurity labs,
IT experiments, programming projects and continuous learning journey.
</p>
